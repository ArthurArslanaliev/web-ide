...
from web_ide.repository.views import StructureView, ContentView, CreateEntityView, RenameEntityView, ExecuteCommandView
...
urlpatterns = [
    ...
    url(r'^structure/(?P<local_repository_id>[0-9]+)/execute/?$', ExecuteCommandView.as_view()),
